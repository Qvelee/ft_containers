...
void	TestMoreMap()
{
	...
	pair<map<int, int>::const_iterator, map<int, int>::const_iterator>	range1 = map1.equal_range(6);
	std::cout << range1.first->first << ' ';
	std::cout << range1.second->first << std::endl;
	std::cout << "----------\n";

	map<int, int>	mapp2;
	pair<map<int, int>::iterator, map<int, int>::iterator>
	range2 = mapp2.equal_range(1);
	std::cout << range2.first->first << ' ';
	std::cout << range2.second->first << std::endl;
	std::cout << "----------\n";
...
void	TestCompare()
{
	...
	map<int, int>::const_iterator	itc = mymap.begin();
	
	std::cout << (it == itc) << std::endl;
	std::cout << (it != itc) << std::endl;

	map<int, int>::reverse_iterator			rit = mymap.rend();
	map<int, int>::const_reverse_iterator	ritc = mymap.rend();
